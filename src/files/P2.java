...
public class P2 {
    public static void main(String[] args) throws IOException {
        ...
        // test all tokens
        testAllTokens();
        testAllTokens("FALSE_SYMBOL", "FALSE_SYMBOL_OUT.txt");
        //outTest();
        testIdentifier("TEST_IDENTIFIER", "TEST_IDENTIFIER_OUT.txt");
        testAllTokens("string_test.txt", "string_test_out.txt");
        CharNum.num = 1;
        // ADD CALLS TO OTHER TEST METHODS HERE
    }

    private static void testIdentifier(String inputFile, String outputFile) throws IOException {
    ...
    private static void outTest() throws IOException {
        // open input and output files
        FileReader inFile = null;
        PrintWriter outFile = null;
        try {
        ...
        while (token.sym != sym.EOF) {
            switch (token.sym) {
                ...
                case sym.RETURN:
                    ...
                    break;
                case sym.ID:
                    outFile.println(((IdTokenVal)token.value).idVal + " is identifier at line " +
                    ((IdTokenVal)token.value).linenum + " char "
